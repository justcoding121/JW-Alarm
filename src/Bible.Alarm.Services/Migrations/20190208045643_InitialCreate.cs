    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BibleReadingSchedule", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BibleReadingSchedule_AlarmSchedules_AlarmScheduleId",
                        column: x => x.AlarmScheduleId,
                        principalTable: "AlarmSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BibleReadingSchedule_AlarmScheduleId",
                table: "BibleReadingSchedule",
                column: "AlarmScheduleId",
                unique: true);
        }
